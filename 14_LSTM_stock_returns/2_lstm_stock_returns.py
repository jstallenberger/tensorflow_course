...
plt.legend()
plt.show()
plt.savefig('/project/14_LSTM_stock_returns/2_stock_returns_loss.png')
plt.close()
...
plt.legend()
plt.show()
plt.savefig('/project/14_LSTM_stock_returns/2_stock_returns_onestep_predictions.png')
plt.close()
...
plt.legend()
plt.show()
plt.savefig('/project/14_LSTM_stock_returns/2_stock_returns_multistep_predictions.png')
plt.close()