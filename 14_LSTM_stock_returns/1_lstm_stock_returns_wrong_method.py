...
series = df['close'].values.reshape(-1, 1) # reshape to an N x 1 matrix
...
plt.legend()
plt.show()
plt.savefig('/project/14_LSTM_stock_returns/1_wrong_method_loss.png')
plt.close()
...
plt.legend()
plt.show()
plt.savefig('/project/14_LSTM_stock_returns/1_wrong_method_onestep_predictions.png')
plt.close()
...
plt.legend()
plt.show()
plt.savefig('/project/14_LSTM_stock_returns/1_wrong_method_multistep_predictions.png')
plt.close()